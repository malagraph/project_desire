...
# Configure alligned depth/color frame
config = rs.config()
...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data/yolov3-tiny_weights.h5',
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            # print('Bounding Box Coords: TL (%d, %d) TR (%d, %d) BL (%d, %d) BR (%d, %d) \n' %(left, top, right, top, left, bottom, right, bottom))
